...
CREATE TABLE IF NOT EXISTS `lab3`.`Class` (
  ...
  UNIQUE INDEX `Class_head_teacher_UNIQUE` (`Class_head_teacher` ASC)   ,
...
CREATE TABLE IF NOT EXISTS `lab3`.`Student status change` (
  ...
  `Original_class_id` VARCHAR(10) NOT NULL,
...
-- -----------------------------------------------------
-- Table `lab3`.`Time slot`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lab3`.`Time slot` (
...
CREATE TABLE IF NOT EXISTS `lab3`.`Section` (
  ...
  `Time slot_Time_slot_id` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`Course_id`, `Teacher_id`, `Year`, `Semester`),
  INDEX `fk_Course_has_Time slot_Time slot1_idx` (`Time slot_Time_slot_id` ASC)   ,
  ...
  CONSTRAINT `fk_Course_has_Time slot_Time slot1`
    FOREIGN KEY (`Time slot_Time_slot_id`)
    REFERENCES `lab3`.`Time slot` (`Time_slot_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
